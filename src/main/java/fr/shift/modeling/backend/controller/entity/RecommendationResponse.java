...
public class RecommendationResponse {
    ...
    RecommendationHolder recommendations;
    RequestHandlingInfo<RecommendationRequest> infos;

    public RecommendationHolder getRecommendations() {
        return recommendations;
    }

    public void setRecommendations(RecommendationHolder recommendations) {
        this.recommendations = recommendations;
    }

    public RequestHandlingInfo<RecommendationRequest> getInfos() {
        return infos;
    }

    public void setInfos(RequestHandlingInfo<RecommendationRequest> infos) {
        this.infos = infos;
    }
}
